...
- Name: exam.spec.ts >> GH-600 exam flow >> matching_magnet question renders selects not empty inputs
- Location: tests/e2e/exam.spec.ts:207:3
...
> 210 |     await expect(page.locator("#examView")).toBeVisible({ timeout: 5_000 });
  ...
  258 |       if (isLast) break;
  259 |       if (await nextBtn.isVisible()) await nextBtn.click();
  260 |     }
  261 |     expect(found).toBe(true);
  262 |   });
  263 | });
  264 | 
```